...
function nameCheck(name) {
  let output = `Cool name, ${name}`;

  if (name === "Steven") {
    output = "What is up Steven?";
  } else if (name === "Bryan") {
    output = "Hey Bryan!";
  }
...
function faveColorFinder(color) {
  let output = "you need to evaluate your favorite color choice";

  if (color === "red") {
    output = "red is a great color";
  } else if (color === "green") {
    output = "green is a solid favorite color";
  } else if (color === "black") {
    output = "so trendy";
  }
...
function thatsOdd(num) {
  ...
  if (num % 2 === 0) {
    output = "That's not odd!";
  } else {
    output = "That is odd indeed!";
  }
...
function emailCheck(email) {
  let verified = "must provide a valid email address";
...
//console.log(emailCheck(" kyle@gmail.com   "));
...
//CODE HERE
const buyFrogs2 = gold => Math.trunc(gold / 3);
...
let arrayIsAscending = checkSortedAsc(sampleArray);

// console.log(arrayIsAscending);
// console.log(checkSortedAsc([2, 5, 7, 100]));
